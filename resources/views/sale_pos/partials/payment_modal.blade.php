			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						...
						<p class="info-box-number mb-4">Accept CARD Payment of Rs. <span id="total_payable"></span></p>	
						<p>Card Details Optional</p>
...
<div class="modal fade" tabindex="-1" role="dialog" id="upi_details_modal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
							...
							<div class="col-md-4">
								<div class="form-group">
									{!! Form::label("transaction_no_1_0", 'Reference No (Optional)') !!}
									{!! Form::text("payment[0][transaction_no_1]", null, ['class' => 'form-control', 'placeholder' => 'Reference No', 'id' => "transaction_no_1_0", 'autofocus']); !!}
								</div>
							</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="pos-save-upi">ACCEPT</button>
			</div>
